\documentclass[10pt, a4paper]{article}
    ...
    \titlespacing*{\section}{0pt}{0.25\baselineskip}{0.23\baselineskip}
        ...
        \sect{Projects}
            \begin{tabular}{L!{\vsep}R}
                C Group Project & \textbf{(2019)}
                    ...
                    \\
                eduCATe & \textbf{(2019)}
                    For ICHack 19, we implemented a chat platform tailored for educational purposes.
                    Our design used a similar threading system to Slack for each assignment, in order to maintain organisation.
                    I designed, and implemented, the backend (built mostly on PHP), with a focus on cross-platform compatibility.
                    Our frontend was an Android application.
                    \\
                Yeetr & \textbf{(2018)}
